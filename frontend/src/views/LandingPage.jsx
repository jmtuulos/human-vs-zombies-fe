            ...
            {data.map((e) =>
              <li key={e.id} className="list-group-item" style={{ backgroundColor: '#e9e3d6a3' }}>
                <Button onClick={() => handleSelectClick(e)} variant="text" style={{ color: '#524e45' }}>
                  {e.name}  &emsp; &#x25cf; &emsp;  {e.gameState} &emsp; &#x25cf; &emsp; players: <NumberOfPlayers id={e.id} /> &emsp; &#x25cf; &emsp; started: {new Date(e.startDateTime).toString().slice(0, 21)} &emsp; &#x25cf; &emsp; {e.description}</Button>
              </li>)
            }
          </ul>
        </div>
